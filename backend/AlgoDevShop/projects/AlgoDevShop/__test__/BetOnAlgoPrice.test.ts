...
import { BetOnAlgoPriceClient, BetOnAlgoPriceFactory } from '../contracts/clients/BetOnAlgoPriceClient';

const fixture = algorandFixture();
Config.configure({ populateAppCallResources: true });

let appClient: BetOnAlgoPriceClient;

describe('BetOnAlgoPrice', () => {
  ...
  beforeAll(async () => {
    ...
    const factory = new BetOnAlgoPriceFactory({
      algorand,
